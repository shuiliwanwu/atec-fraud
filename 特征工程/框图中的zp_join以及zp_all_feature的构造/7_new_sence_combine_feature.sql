...
select 
	event_id,
----------------------------------    
	case when network_same_1hour_is_first=1 or ip_city_same_1hour_is_first=1 then 1 else 0 end as ip_scene_1hour_first,
   	case when mobile_oper_platform_same_1hour_is_first=1 or device_sign_same_1hour_is_first=1 then 1 else 0 end as mobile_scene_1hour_first,
	case when operation_channel_same_1hour_is_first=1 or pay_scene_same_1hour_is_first=1 or is_peer_pay_same_1hour_is_first=1 then 1 else 0 end as pay_scene_1hour_first,

	(network_same_1hour_is_first+
    ip_city_same_1hour_is_first+
    mobile_oper_platform_same_1hour_is_first+
    device_sign_same_1hour_is_first+
    operation_channel_same_1hour_is_first+
    pay_scene_same_1hour_is_first+
    is_peer_pay_same_1hour_is_first) as all_is_first_1hour,
    
    network_same_1hour_rate + ip_city_same_1hour_rate as ip_scene_1hour_first_rate,
    mobile_oper_platform_same_1hour_rate + device_sign_same_1hour_rate as mobile_scene_1hour_rate,
    operation_channel_same_1hour_rate + pay_scene_same_1hour_rate + is_peer_pay_same_1hour_rate as pay_scene_1hour_rate,
    
----------------------------------    
	case when network_same_5hour_is_first=1 or ip_city_same_5hour_is_first=1 then 1 else 0 end as ip_scene_5hour_first,
   	case when mobile_oper_platform_same_5hour_is_first=1 or device_sign_same_5hour_is_first=1 then 1 else 0 end as mobile_scene_5hour_first,
	case when operation_channel_same_5hour_is_first=1 or pay_scene_same_5hour_is_first=1 or is_peer_pay_same_5hour_is_first=1 then 1 else 0 end as pay_scene_5hour_first,

	(network_same_5hour_is_first+
    ip_city_same_5hour_is_first+
    mobile_oper_platform_same_5hour_is_first+
    device_sign_same_5hour_is_first+
    operation_channel_same_5hour_is_first+
    pay_scene_same_5hour_is_first+
    is_peer_pay_same_5hour_is_first) as all_is_first_5hour,
    
    network_same_5hour_rate + ip_city_same_5hour_rate as ip_scene_5hour_first_rate,
    mobile_oper_platform_same_5hour_rate + device_sign_same_5hour_rate as mobile_scene_5hour_rate,
    operation_channel_same_5hour_rate + pay_scene_same_5hour_rate + is_peer_pay_same_5hour_rate as pay_scene_5hour_rate,

----------------------------------    
	case when network_same_12hour_is_first=1 or ip_city_same_12hour_is_first=1 then 1 else 0 end as ip_scene_12hour_first,
   	case when mobile_oper_platform_same_12hour_is_first=1 or device_sign_same_12hour_is_first=1 then 1 else 0 end as mobile_scene_12hour_first,
	case when operation_channel_same_12hour_is_first=1 or pay_scene_same_12hour_is_first=1 or is_peer_pay_same_12hour_is_first=1 then 1 else 0 end as pay_scene_12hour_first,

	(network_same_12hour_is_first+
    ip_city_same_12hour_is_first+
    mobile_oper_platform_same_12hour_is_first+
    device_sign_same_12hour_is_first+
    operation_channel_same_12hour_is_first+
    pay_scene_same_12hour_is_first+
    is_peer_pay_same_12hour_is_first) as all_is_first_12hour,
    
    network_same_12hour_rate + ip_city_same_12hour_rate as ip_scene_12hour_first_rate,
    mobile_oper_platform_same_12hour_rate + device_sign_same_12hour_rate as mobile_scene_12hour_rate,
    operation_channel_same_12hour_rate + pay_scene_same_12hour_rate + is_peer_pay_same_12hour_rate as pay_scene_12hour_rate,
----------------------------------    
